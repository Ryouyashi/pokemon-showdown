export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	wigglytuff: {
		...
		types: ["Normal", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 140, atk: 70, def: 70, spa: 95, spd: 75, spe: 50},
	...
	parasect: {
		...
		name: "Parasect",
		types: ["Bug", "Ghost"],
		baseStats: {hp: 60, atk: 115, def: 90, spa: 60, spd: 90, spe: 30},
		abilities: {0: "Effect Spore", 1: "Dry Skin", H: "Damp"},
		heightm: 1,
		weightkg: 29.5,
		color: "Red",
	...
	arcanine: {
		...
		evoItem: "Fire Stone",
		eggGroups: ["Field"],
		otherFormes: ["Arcanine-Mythos"],
		formeOrder: ["Arcanine", "Arcanine-Mythos"],
	},
	arcaninemythos: {
		num: 59,
		name: "Arcanine-Mythos",
		baseSpecies: "Arcanine",
		forme: "Mythos",
		types: ["Ghost", "Dark"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 90, atk: 100, def: 80, spa: 110, spd: 80, spe: 95},
		abilities: {0: "Intimidate", 1: "Cursed Body", H: "Defiant"},
		heightm: 1.9,
		weightkg: 155,
		color: "Brown",
		prevo: "Growlithe",
	...
	rapidash: {
		...
		name: "Rapidash",
		types: ["Fire"],
		baseStats: {hp: 65, atk: 120, def: 70, spa: 80, spd: 80, spe: 105},
		abilities: {0: "Run Away", 1: "Flash Fire", H: "Flame Body"},
		heightm: 1.7,
		weightkg: 95,
		color: "Yellow",
	...
	hypnomythos: {
		...
		forme: "Mythos",
		types: ["Psychic", "Ghost"],
		baseStats: {hp: 85, atk: 53, def: 90, spa: 80, spd: 115, spe: 60},
		abilities: {0: "No Guard", 1: "Bad Dreams", H: "Prankster"},
		heightm: 1.6,
		weightkg: 75.6,
		color: "Yellow",
		prevo: "Drowzee",
	...
	seaking: {
		...
		name: "Seaking",
		types: ["Water"],
		baseStats: {hp: 80, atk: 112, def: 75, spa: 95, spd: 80, spe: 68},
		abilities: {0: "Swift Swim", 1: "Water Veil", H: "Lightning Rod"},
		heightm: 1.3,
		weightkg: 39,
		color: "Red",
	...
	scythermythos: {
		...
		eggGroups: ["Bug"],
		otherFormes: ["Scyther"],
		formeOrder: ["Scyther", "Scyther-Mythos"],
	},
	jynx: {
		num: 124,
		name: "Jynx",
	...
	snorlax: {
		...
		eggGroups: ["Monster"],
		canHatch: true,
		otherFormes: ["Snorlax-Mythos"],
		formeOrder: ["Snorlax", "Snorlax-Mythos"],
	...
	snorlaxmythos: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 160, atk: 110, def: 65, spa: 65, spd: 110, spe: 30},
		abilities: {0: "Grass Pelt", 1: "Thick Fat", H: "Comatose"},
		heightm: 2.1,
		weightkg: 460,
		color: "Black",
		prevo: "Munchlax",
	...
	dragonite: {
		...
		evoLevel: 55,
		eggGroups: ["Water 1", "Dragon"],
		otherFormes: ["Dragonite-Mythos"],
		formeOrder: ["Dragonite", "Dragonite-Mythos"],
	},
	dragonitemythos: {
		num: 149,
		name: "Dragonite-Mythos",
		baseSpecies: "Dragonite",
		forme: "Mythos",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 90, atk: 110, def: 90, spa: 110, spd: 90, spe: 110},
		abilities: {0: "Pixilate", 1: "Marvel Scale", H: "Multiscale"},
		heightm: 2.2,
		weightkg: 210,
		color: "Brown",
		prevo: "Dragonair",
	...
	chikorita: {
		...
		evos: ["Bayleef"],
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Chikorita-Mythos"],
		formeOrder: ["Chikorita", "Chikorita-Mythos"],
	},
	bayleef: {
		num: 153,
		name: "Bayleef",
		...
		evos: ["Meganium"],
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Bayleef-Mythos"],
		formeOrder: ["Bayleef", "Bayleef-Mythos"],
	},
	meganium: {
		num: 154,
		name: "Meganium",
		...
		evoLevel: 32,
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Meganium-Mythos"],
		formeOrder: ["Meganium", "Meganium-Mythos"],
	},
	chikoritamythos: {
		num: 152,
		name: "Chikorita-Mythos",
		types: ["Bug", "Dragon"],
		baseSpecies: "Chikorita",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 45, atk: 39, def: 65, spa: 59, spd: 65, spe: 45},
		abilities: {0: "Sap Sipper", 1: "Marvel Scale", H: "Persistent"},
		heightm: 0.9,
		weightkg: 6.4,
		color: "Green",
		evos: ["Bayleef-Mythos"],
	...
	bayleefmythos: {
		...
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 52, def: 80, spa: 73, spd: 80, spe: 60},
		abilities: {0: "Sap Sipper", 1: "Marvel Scale", H: "Persistent"},
		heightm: 1.2,
		weightkg: 15.8,
		color: "Green",
		prevo: "Chikorita-Mythos",
		evoLevel: 16,
		evos: ["Meganium-Mythos"],
		eggGroups: ["Monster", "Grass"],
	},
	meganiummythos: {
		num: 154,
		name: "Meganium-Mythos",
		types: ["Bug", "Dragon"],
		baseSpecies: "Meganium",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 72, def: 100, spa: 93, spd: 100, spe: 80},
		abilities: {0: "Sap Sipper", 1: "Marvel Scale", H: "Persistent"},
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
		prevo: "Bayleef-Mythos",
		evoLevel: 32,
		eggGroups: ["Monster", "Grass"],
	},
	cyndaquil: {
		...
		evos: ["Quilava"],
		eggGroups: ["Field"],
		otherFormes: ["Cyndaquil-Mythos"],
		formeOrder: ["Cyndaquil", "Cyndaquil-Mythos"],
	},
	quilava: {
		num: 156,
		name: "Quilava",
		...
		evos: ["Typhlosion"],
		eggGroups: ["Field"],
		otherFormes: ["Quilava-Mythos"],
		formeOrder: ["Quilava", "Quilava-Mythos"],
	},
	typhlosion: {
		num: 157,
		name: "Typhlosion",
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Typhlosion-Mythos"],
		formeOrder: ["Typhlosion", "Typhlosion-Mythos"],
	},
	cyndaquilmythos: {
		num: 155,
		name: "Cyndaquil-Mythos",
		types: ["Poison", "Ground"],
		baseSpecies: "Cyndaquil",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 39, atk: 60, def: 52, spa: 38, spd: 50, spe: 70},
		abilities: {0: "Vital Spirit", 1: "Defiant", H: "Protean"},
		heightm: 0.5,
		weightkg: 7.9,
		color: "Yellow",
		evos: ["Quilava-Mythos"],
	...
	quilavamythos: {
		...
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 58, atk: 80, def: 64, spa: 53, spd: 65, spe: 86},
		abilities: {0: "Vital Spirit", 1: "Defiant", H: "Protean"},
		heightm: 0.9,
		weightkg: 19,
		color: "Yellow",
		prevo: "Cyndaquil-Mythos",
		evoLevel: 14,
		evos: ["Typhlosion-Mythos"],
		eggGroups: ["Field"],
	},
	typhlosionmythos: {
		num: 157,
		name: "Typhlosion-Mythos",
		types: ["Poison", "Ground"],
		baseSpecies: "Typhlosion",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 109, def: 84, spa: 79, spd: 85, spe: 105},
		abilities: {0: "Vital Spirit", 1: "Defiant", H: "Protean"},
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
		prevo: "Quilava-Mythos",
		evoLevel: 36,
		eggGroups: ["Field"],
	},
	totodile: {
		...
		evos: ["Croconaw"],
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Totodile-Mythos"],
		formeOrder: ["Totodile", "Totodile-Mythos"],
	},
	croconaw: {
		num: 159,
		name: "Croconaw",
		...
		evos: ["Feraligatr"],
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Croconaw-Mythos"],
		formeOrder: ["Croconaw", "Croconaw-Mythos"],
	},
	feraligatr: {
		num: 160,
		name: "Feraligatr",
		...
		evoLevel: 30,
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Feraligatr-Mythos"],
		formeOrder: ["Feraligatr", "Feraligatr-Mythos"],
	},
	totodilemythos: {
		num: 158,
		name: "Totodile-Mythos",
		types: ["Water", "Fighting"],
		baseSpecies: "Totodile",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 50, atk: 65, def: 64, spa: 30, spd: 55, spe: 53},
		abilities: {0: "Dry Skin", 1: "Iron Fist", H: "Moxie"},
		heightm: 0.6,
		weightkg: 9.5,
		color: "Blue",
		evos: ["Croconaw-Mythos"],
		eggGroups: ["Monster", "Water 1"],
	},
	croconawmythos: {
		num: 159,
		name: "Croconaw-Mythos",
		types: ["Water", "Fighting"],
		baseSpecies: "Croconaw",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 80, def: 80, spa: 40, spd: 67, spe: 68},
		abilities: {0: "Dry Skin", 1: "Iron Fist", H: "Moxie"},
		heightm: 1.1,
		weightkg: 25,
		color: "Blue",
		prevo: "Totodile-Mythos",
		evoLevel: 18,
		evos: ["Feraligatr-Mythos"],
		eggGroups: ["Monster", "Water 1"],
	},
	feraligatrmythos: {
		num: 160,
		name: "Feraligatr-Mythos",
		types: ["Water", "Fighting"],
		baseSpecies: "Feraligatr",
		forme: "Mythos",
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 105, def: 100, spa: 54, spd: 67, spe: 98},
		abilities: {0: "Dry Skin", 1: "Iron Fist", H: "Moxie"},
		heightm: 2.3,
		weightkg: 88.8,
		color: "Blue",
		prevo: "Croconaw-Mythos",
		evoLevel: 30,
		eggGroups: ["Monster", "Water 1"],
	},
	sentret: {
	...
	furret: {
		...
		name: "Furret",
		types: ["Normal"],
		baseStats: {hp: 85, atk: 76, def: 74, spa: 45, spd: 75, spe: 90},
		abilities: {0: "Run Away", 1: "Keen Eye", H: "Frisk"},
		heightm: 1.8,
		weightkg: 32.5,
		color: "Brown",
		...
		evoLevel: 15,
		eggGroups: ["Field"],
		otherFormes: ["Furret-Mythos"],
		formeOrder: ["Furret", "Furret-Mythos"],
	},
	furretmythos: {
		num: 162,
		name: "Furret-Mythos",
		...
		forme: "Mythos",
		types: ["Normal", "Water"],
		baseStats: {hp: 85, atk: 86, def: 74, spa: 35, spd: 75, spe: 90},
		abilities: {0: "Water Bubble", 1: "Frisk", H: "Fur Coat"},
		heightm: 1.8,
		weightkg: 32.5,
		color: "Brown",
		prevo: "Sentret",
	...
	noctowl: {
		...
		name: "Noctowl",
		types: ["Normal", "Flying"],
		baseStats: {hp: 100, atk: 50, def: 55, spa: 106, spd: 96, spe: 80},
		abilities: {0: "Insomnia", 1: "Keen Eye", H: "Tinted Lens"},
		heightm: 1.6,
		weightkg: 40.8,
		color: "Brown",
		...
		evoLevel: 20,
		eggGroups: ["Flying"],
		otherFormes: ["Noctowl-Mythos"],
		formeOrder: ["Noctowl", "Noctowl-Mythos"],
	},
	noctowlmythos: {
		num: 164,
		name: "Noctowl-Mythos",
		...
		forme: "Mythos",
		types: ["Ice", "Flying"],
		baseStats: {hp: 100, atk: 106, def: 65, spa: 50, spd: 86, spe: 80},
		abilities: {0: "Tinted Lens", 1: "Slush Rush", H: "Adaptability"},
		heightm: 1.6,
		weightkg: 40.8,
		color: "Brown",
		prevo: "Hoothoot",
	...
	crobat: {
		...
		evoType: "levelFriendship",
		eggGroups: ["Flying"],
		otherFormes: ["Crobat-Mythos"],
		formeOrder: ["Crobat", "Crobat-Mythos"],
	},
	crobatmythos: {
		num: 169,
		name: "Crobat-Mythos",
		...
		abilities: {0: "Corrosion", 1: "Levitate", H: "Infiltrator"},
		heightm: 1.8,
		weightkg: 75,
		color: "Purple",
		prevo: "Golbat",
	...
	lanturn: {
		...
		name: "Lanturn",
		types: ["Water", "Electric"],
		baseStats: {hp: 125, atk: 58, def: 68, spa: 96, spd: 76, spe: 72},
		abilities: {0: "Volt Absorb", 1: "Illuminate", H: "Water Absorb"},
		heightm: 1.2,
		weightkg: 22.5,
		color: "Blue",
	...
	scizormythos: {
		...
		forme: "Mythos",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 70, atk: 120, def: 100, spa: 50, spd: 80, spe: 80},
		abilities: {0: "Bulletproof", 1: "Technician", H: "Battle Armor"},
		heightm: 1.8,
		weightkg: 118,
		color: "Red",
		prevo: "Scyther-Mythos",
		evoType: "trade",
		evoItem: "Metal Coat",
		eggGroups: ["Bug"],
		otherFormes: ["Scizor"],
		formeOrder: ["Scizor", "Scizor-Mythos"],
	},
	shuckle: {
		num: 213,
		name: "Shuckle",
	...
	stantlermega: {
		...
		forme: "Mega",
		types: ["Normal", "Psychic"],
		baseStats: {hp: 73, atk: 135, def: 67, spa: 105, spd: 70, spe: 115},
		abilities: {0: "Compound Eyes"},
		heightm: 1.4,
		weightkg: 71.2,
		color: "Brown",
		eggGroups: ["Field"],
		requiredItem: "Stantlite",
	},
	smeargle: {
		num: 235,
		name: "Smeargle",
	...
	mightyena: {
		...
		name: "Mightyena",
		types: ["Dark"],
		baseStats: {hp: 70, atk: 105, def: 70, spa: 50, spd: 70, spe: 85},
		...
		evoLevel: 18,
		eggGroups: ["Field"],
		otherFormes: ["Mightyena-Mythos"],
		formeOrder: ["Mightyena", "Mightyena-Mythos"],
	},
	mightyenamythos: {
		num: 262,
		name: "Mightyena-Mythos",
		baseSpecies: "Mightyena",
		forme: "Mythos",
		types: ["Fighting", "Fairy"],
		baseStats: {hp: 70, atk: 105, def: 70, spa: 50, spd: 70, spe: 85},
		abilities: {0: "Intimidate", 1: "Justified", H: "Moxie"},
		heightm: 1,
		weightkg: 37,
		color: "Gray",
		prevo: "Poochyena",
	...
	beautifly: {
		...
		evoLevel: 10,
		eggGroups: ["Bug"],
		otherFormes: ["beautiflymythos"],
	},
	beautiflymythos: {
		num: 267,
		name: "Beautifly-Mythos",
		baseSpecies: "Beautifly",
		types: ["Bug", "Dark"],
		baseStats: {hp: 60, atk: 50, def: 70, spa: 110, spd: 70, spe: 85},
		abilities: {0: "Mimicry", H: "Queenly Majesty"},
		heightm: 1,
		weightkg: 28.4,
		color: "Yellow",
		prevo: "silcoon",
	...
	dustoxmythos: {
		...
		baseSpecies: "Dustox",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 80, atk: 50, def: 80, spa: 80, spd: 100, spe: 65},
		abilities: {0: "Shield Dust", H: "Fluffy"},
		heightm: 1.2,
		weightkg: 31.6,
		color: "Pink",
		prevo: "cascoon",
	...
	masquerain: {
		...
		evoLevel: 22,
		eggGroups: ["Water 1", "Bug"],
		otherFormes: ["Masquerain-Mythos"],
		formeOrder: ["Masquerain", "Masquerain-Mythos"],
	},
	masquerainmythos: {
		num: 284,
		name: "Masquerain-Mythos",
		baseSpecies: "Masquerain",
		forme: "Mythos",
		types: ["Bug", "Ground"],
		baseStats: {hp: 70, atk: 50, def: 62, spa: 110, spd: 62, spe: 110},
		abilities: {0: "Intimidate", 1: "Infiltrator", H: "Competitive"},
		heightm: 0.8,
		weightkg: 3.6,
		color: "Blue",
		prevo: "Surskit",
	...
	volbeatmega: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 65, atk: 103, def: 105, spa: 47, spd: 90, spe: 120},
	...
	flygonmega: {
		...
		forme: "Mega",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 80, atk: 130, def: 85, spa: 120, spd: 85, spe: 120},
		abilities: {0: "Sheer Force"},
		heightm: 2.4,
		weightkg: 150,
		color: "Green",
	...
	flygonmythos: {
		...
		abilities: {0: "Mountaineer", H: "Slush Rush"},
		heightm: 2,
		weightkg: 90,
		color: "White",
		prevo: "Vibrava",
		evoLevel: 45,
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["flygonmythosmega"],
	},
	flygonmythosmega: {
		num: 330,
		name: "Flygon-Mythos-Mega",
		baseSpecies: "Flygon",
		forme: "Mega",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 80, atk: 100, def: 95, spa: 130, spd: 95, spe: 120},
		abilities: {0: "Sheer Force"},
		heightm: 2,
		weightkg: 130,
		color: "White",
		eggGroups: ["Bug", "Dragon"],
		requiredItem: "Flygonite M",
	},
	cacnea: {
		num: 331,
		name: "Cacnea",
	...
	lunatonemega: {
		...
		types: ["Rock", "Psychic"],
		gender: "N",
		baseStats: {hp: 90, atk: 55, def: 95, spa: 125, spd: 115, spe: 80},
		abilities: {0: "Levitate"},
		heightm: 1,
		weightkg: 168,
		color: "Yellow",
		eggGroups: ["Mineral"],
		requiredItem: "Lunatite",
	},
	solrock: {
		num: 338,
		name: "Solrock",
	...
	solrockmega: {
		...
		types: ["Rock", "Psychic"],
		gender: "N",
		baseStats: {hp: 90, atk: 125, def: 115, spa: 55, spd: 95, spe: 80},
		abilities: {0: "Levitate"},
		heightm: 1.2,
		weightkg: 154,
		color: "Red",
		eggGroups: ["Mineral"],
		requiredItem: "Solrite",
	},
	barboach: {
		num: 339,
		name: "Barboach",
	...
	castform: {
		...
		abilities: {0: "Forecast", H: "Adaptability"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Gray",
	...
	castformsunny: {
		...
		forme: "Sunny",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 90, atk: 50, def: 75, spa: 120, spd: 75, spe: 100},
		abilities: {0: "Forecast", H: "Adaptability"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Red",
	...
	castformrainy: {
		...
		forme: "Rainy",
		types: ["Water", "Fairy"],
		baseStats: {hp: 90, atk: 50, def: 110, spa: 75, spd: 110, spe: 70},
		abilities: {0: "Forecast", H: "Adaptability"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Blue",
	...
	castformsnowy: {
		...
		forme: "Snowy",
		types: ["Ice", "Fairy"],
		baseStats: {hp: 70, atk: 110, def: 50, spa: 120, spd: 50, spe: 110},
		abilities: {0: "Forecast", H: "Adaptability"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "White",
	...
	castformsandy: {
		...
		forme: "Sandy",
		types: ["Ground", "Fairy"],
		baseStats: {hp: 80, atk: 90, def: 70, spa: 110, spd: 70, spe: 90},
		abilities: {0: "Forecast", H: "Adaptability"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Brown",
	...
	tropius: {
		...
		name: "Tropius",
		types: ["Grass", "Flying"],
		baseStats: {hp: 99, atk: 98, def: 83, spa: 92, spd: 87, spe: 61},
	...
	wormadamsandy: {
		...
		types: ["Bug", "Ground"],
		gender: "F",
		baseStats: {hp: 60, atk: 59, def: 105, spa: 99, spd: 105, spe: 36},
		abilities: {0: "Levitate", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Brown",
	...
	vespiquen: {
		...
		types: ["Bug", "Poison"],
		gender: "F",
		baseStats: {hp: 70, atk: 100, def: 102, spa: 100, spd: 102, spe: 40},
	...
	cherrim: {
		...
		evoLevel: 25,
		eggGroups: ["Fairy", "Grass"],
		otherFormes: ["Cherrim-Sunshine", "Cherrim-Mega"],
		formeOrder: ["Cherrim", "Cherrim-Sunshine", "Cherrim-Mega"],
	},
	cherrimmega: {
		num: 421,
		name: "Cherrim-Mega",
		...
		forme: "Mega",
		types: ["Grass", "Fire"],
		baseStats: {hp: 70, atk: 60, def: 75, spa: 132, spd: 88, spe: 125},
		abilities: {0: "Drought"},
		heightm: 0.7,
		weightkg: 15,
		color: "Pink",
		eggGroups: ["Fairy", "Grass"],
		requiredItem: "Cherrimite",
	},
	cherrimsunshine: {
		num: 421,
	...
	drapionmega: {
		...
		forme: "Mega",
		types: ["Poison", "Dark"],
		baseStats: {hp: 70, atk: 130, def: 130, spa: 60, spd: 105, spe: 105},
	...
	electivire: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 75, atk: 123, def: 95, spa: 67, spd: 85, spe: 95},
	...
	emboarmega: {
		...
		forme: "Mega",
		types: ["Fire", "Fighting"],
		baseStats: {hp: 100, atk: 143, def: 85, spa: 130, spd: 85, spe: 85},
	...
	samurottmega: {
		...
		forme: "Mega",
		types: ["Water", "Steel"],
		baseStats: {hp: 95, atk: 125, def: 90, spa: 128, spd: 90, spe: 100},
	...
	carracosta: {
		...
		types: ["Water", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 74, atk: 108, def: 133, spa: 83, spd: 75, spe: 42},
		abilities: {0: "Solid Rock", 1: "Sturdy", H: "Swift Swim"},
		heightm: 1.2,
		weightkg: 81,
		color: "Blue",
	...
	stunfisk: {
		...
		baseStats: {hp: 109, atk: 66, def: 84, spa: 91, spd: 99, spe: 32},
	...
	golurkmega: {
		...
		types: ["Ground", "Ghost"],
		gender: "N",
		baseStats: {hp: 89, atk: 164, def: 90, spa: 55, spd: 90, spe: 95},
		abilities: {0: "No Guard"},
		heightm: 2.8,
		weightkg: 330,
		color: "Green",
	...
	gogoat: {
		...
		name: "Gogoat",
		types: ["Grass"],
		baseStats: {hp: 123, atk: 115, def: 82, spa: 97, spd: 81, spe: 68},
		abilities: {0: "Sap Sipper", H: "Grass Pelt"},
		heightm: 1.7,
		weightkg: 91,
		color: "Brown",
	...
	meowsticmythos: {
		num: 678,
		name: "Meowstic-Mythos",
		baseSpecies: "Meowstic",
		forme: "Mythos",
		baseForme: "Meowstic",
		types: ["Poison", "Ice"],
		gender: "M",
		baseStats: {hp: 84, atk: 48, def: 86, spa: 63, spd: 81, spe: 104},
		abilities: {0: "Fur Coat", 1: "Frisk", H: "Pure Power"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Blue",
		prevo: "Espurr",
	...
	meowsticfmythos: {
		num: 678,
		name: "Meowstic-F-Mythos",
		baseSpecies: "Meowstic",
		forme: "Mythos",
		baseForme: "Meowstic-F",
		types: ["Poison", "Fighting"],
		gender: "F",
		baseStats: {hp: 84, atk: 48, def: 86, spa: 63, spd: 81, spe: 104},
		abilities: {0: "Fur Coat", 1: "Friend Guard", H: "Pure Power"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Blue",
		prevo: "Espurr",
	...
	aurorus: {
		...
		types: ["Rock", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 123, atk: 57, def: 72, spa: 109, spd: 92, spe: 68},
		abilities: {0: "Refrigerate", H: "Snow Warning"},
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	dedenne: {
		...
		color: "Yellow",
		eggGroups: ["Field", "Fairy"],
		otherFormes: ["Dedenne-Mega"],
		formeOrder: ["Dedenne", "Dedenne-Mega"],
	},
	dedennemega: {
		num: 702,
		name: "Dedenne-Mega",
		...
		forme: "Mega",
		types: ["Electric", "Fairy"],
		baseStats: {hp: 67, atk: 48, def: 77, spa: 146, spd: 87, spe: 106},
		abilities: {0: "Static"},
		heightm: 0.2,
		weightkg: 2.2,
		color: "Yellow",
		eggGroups: ["Field", "Fairy"],
		requiredItem: "Dedennite",
	},
	carbink: {
		num: 703,
		name: "Carbink",
	...
	dubwoolmythos: {
		...
		baseStats: {hp: 72, atk: 120, def: 80, spa: 50, spd: 80, spe: 88},
		abilities: {0: "Static", 1: "Bulletproof", H: "Rock Head"},
		heightm: 1.3,
		weightkg: 43,
		color: "White",
		prevo: "Wooloo",
	...
	grapploct: {
		...
		name: "Grapploct",
		types: ["Fighting"],
		baseStats: {hp: 80, atk: 120, def: 90, spa: 70, spd: 90, spe: 42},
		abilities: {0: "Limber", H: "Technician"},
		heightm: 1.6,
		weightkg: 39,
		color: "Blue",
	...
	hatterenemythos: {
		num: 858,
		name: "Hatterene-Mythos",
		baseSpecies: "Hatterene",
		types: ["Water", "Fire"],
		gender: "F",
		baseStats: {hp: 67, atk: 90, def: 95, spa: 136, spd: 103, spe: 19},
		abilities: {0: "Poison Point", 1: "Dazzling", H: "Magic Guard"},
		heightm: 2.1,
		weightkg: 5.1,
		color: "Red",
		prevo: "Hattrem",
	...
	grimmsnarl: {
		...
		evoLevel: 42,
		eggGroups: ["Fairy", "Human-Like"],
		otherFormes: ["Grimmsnarl-Mythos"],
		formeOrder: ["Grimmsnarl", "Grimmsnarl-Mythos"],
		canGigantamax: "G-Max Snooze",
	},
	grimmsnarlmythos: {
		num: 861,
		name: "Grimmsnarl-Mythos",
		baseSpecies: "Grimmsnarl",
		forme: "Mythos",
		types: ["Fire", "Fairy"],
		gender: "M",
		baseStats: {hp: 105, atk: 110, def: 75, spa: 65, spd: 75, spe: 85},
		abilities: {0: "Prankster", 1: "Frisk", H: "Flame Body"},
		heightm: 1.5,
		weightkg: 61,
		color: "Purple",
		prevo: "Morgrem",
